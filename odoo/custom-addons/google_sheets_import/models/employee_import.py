...
class EmployeeImport(models.Model):
        ...
        for user in all_users:
            ...
            if base_email:
                ...
                if original_user:
                    ...
                    _logger.warning(f"⚠️ Usuario duplicado detectado pero no se encontró el original:")
    ...
    def import_employees(self, resume_state=None):
                ...
                try:
                    ...
                    try:
                        ...
                        error_msg = (
                            ...
                            f"   Email: {work_email}\n"
                            f"   Error: {str(e)}\n"
                            f"   ✏️ Corrección: Verificar integridad de datos (facultad, carrera, género válidos)"
                        )
                        return self._show_error_wizard(idx, error_msg, count, created_count, updated_count, skipped_count, facultad_seleccionada)
        ...
        if emails_duplicados:
            _logger.warning(f"⚠️ Emails duplicados en CSV: {len(emails_duplicados)}")
